...
<head>
    <title>
    	OrgChart | Initialize From HTML Table
    </title>
...
<script>
    ...
    getOrgChart.prototype.showEditView = function(a) {
        this._S = true;
        window.open("update.php?edit="+a,"_self");
    ...
    getOrgChart.prototype.insertNode = function(d, a, b) {
        ...
        var e = this.nodes[d];
        //create code
        	window.open("update.php?create="+e.id,"_self");
        this._aM = {
            id: d,
            old_x: e.x,
            old_y: e.y
    ...
    getOrgChart.prototype.removeNode = function(b) {
        ...
        //delete code
        window.open("del.php?q="+a.id,"_self");
        delete this.nodes[b];
        this.loadFromJSON(this.nodes, true, function() {
            e._V("updatedEvent")
        })
    ...
    getOrgChart.prototype.updateNode = function(b, d, a) {
        ...
        if (this._V("updateNodeEvent", {
        	...
        	window.open("update.php?id="+a.id+"&parent="+d,"_self");
            this.loadFromJSON(this.nodes, true, function() {
                e._V("updatedEvent")
            })
        }
...
<body>
	 ...
	 <div style="float: middle; width: 100%; height:100%; text-align:center; display: none;" >
