...
<link rel="stylesheet" href="/wp-content/themes/sydney/styles.css">
<style type = "text/css">
         body {
...
.project-filter li a.active, .project-filter li a:hover,.preloader .pre-bounce1, .preloader .pre-bounce2,.roll-team .team-item .team-pop,.roll-progress .progress-animate,.roll-socials li a:hover,.roll-project .project-item .project-pop,.roll-project .project-filter li.active,.roll-project .project-filter li:hover,.roll-button.light:hover,.roll-button.border:hover,.roll-button,.roll-icon-box.white .icon,.owl-theme .owl-controls .owl-page.active span,.owl-theme .owl-controls.clickable .owl-page:hover span,.go-top,.bottom .socials li:hover a,.sidebar .widget:before,.blog-pagination ul li.active,.blog-pagination ul li:hover a,.content-area .hentry:after,.text-slider .maintitle:after,.error-wrap #search-submit:hover,#mainnav .sub-menu li:hover > a,#mainnav ul li ul:after, button, input[type="button"], input[type="reset"], input[type="submit"], .panel-grid-cell .widget-title:after { background-color:blue}
...
.pull-right{
  float:right;
   ...
   <body>
      <h1>Welcome to Org chart. Please, wait for it.<?php echo $login_session; ?></h1>

<h2><button class="btn btn-secondary pull-right"type="button" onclick="window.location.href='login.php'">Logout</button></h2> this is for login.php page <br/>
If your admin please click here else you cannot edit the form
<h2><button class="btn btn-secondary pull-right" type="button" onclick="window.location.href=' http://empeiros.internship-test.us/org-chart/'">Logout</button></h2> This logout for org chart
<h2><button class="btn btn-secondary pull-right"type="button" onclick="window.location.href='test.html'">Org-Chart</button></h2>
