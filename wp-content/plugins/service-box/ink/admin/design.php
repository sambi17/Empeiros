<?php if ( ! defined( 'ABSPATH' ) ) exit; ?>
  <div class="test_b_admin_wrapper">
	<h3><?php _e('Select Your Testimonial Design Here',wpshopmart_service_box_text_domain); ?></h3>
	<style>
	.checked_temp {
		position: absolute;
		background: #FF2300;
...
#add_wpsm_service_b_design{
	...
	<?php
		...
		if($Wpsm_Servicebox_Settings['service_display_icon']  )   {  
			...
			<div class="demoftr">	
				...
				<div class="">
					<div class="wpsm_home_portfolio_showcase">
						<img class="wpsm_img_responsive ftr_img" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/design/test-'.$i.'.png'?>">
						<span class="img-demo-span"><a style="color:#fff;text-decoration:none" target="_blank" href="http://demo.wpshopmart.com/service-box/demo-<?php echo $i; ?>/">Demo</a></span>
					</div>
				</div>
	...
	<div class="col-md-4">
			<div class="demoftr">	
				<a  target="_blank" href="http://dazzlersoftware.com/wpshopmart-demo/service-showcase-pro-plugin-demo/"><div class="">
					<div class="wpsm_home_portfolio_showcase">
						<img class="wpsm_img_responsive ftr_img" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/design/test-3.jpg'?>">
						</div>
				</div>
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
					<h3 class="text-center pull-left" style="margin-top: 10px;margin-bottom: 10px;font-weight:900">Upgrade To Pro Version</h3>
					</div>		</a>
			</div>	
		</div>
