...
class  CDaily_MiniCalendarWidget extends WP_Widget {
    ...
    public function __construct(){
       // construct a widget
        ...
        $widget_ops=array('classname' => 'cdaily_minicalendarwidget',
                          'description' => __('Mini-Calendar of Events',CDailyPlugin::CAPTION_BUNDLE));
        parent::__construct(false,$name='Connect Daily Mini-Calendar Widget',$widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        echo $renderer->renderMiniCalendar($instance,'cdaily-mini-calendar-'.$args['id']);
        echo $after_widget;
    }
