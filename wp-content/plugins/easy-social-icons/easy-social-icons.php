...
function cnss_db_install () {
	...
	if($wpdb->get_var("show tables like '$table_name'") != $table_name) {
		...
		(1, 'Facebook', 'https://facebook.com/Empeiros-Organization-1484441245008339/', 'fa fa-facebook', 0, '1487164658', 1),
		(2, 'Twitter', 'https://twitter.com/empeiros_org', 'fa fa-twitter', 1, '1487164673', 1),
