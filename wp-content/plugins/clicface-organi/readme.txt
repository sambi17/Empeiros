...
Donate link: https://plugins.clicface.com/
...
Need help? Check our [FAQ](https://plugins.clicface.com/documentation/faq/) or [create a new support ticket](http://support.clicface.com/).
...
To use Clicface Organi, you must first install the [Clicface Trombi plugin](http://wordpress.org/plugins/clicface-trombi/).

1. Go to **Plugins > Add New**
1. Under **Search**, type in the name of the WordPress Plugin : *clicface trombi*
1. Click **Install Now**, then **Proceed**
1. If successful, click **Activate Plugin** to activate it
1. Do the same steps for **Clicface Organi** plugin: go to **Plugins > Add New**
1. Under **Search**, type in the name of the WordPress Plugin : *clicface organi*
1. Click **Install Now**, then **Proceed**
1. If successful, click **Activate Plugin** to activate it
...
= What are the requirements to install the Clicface Organi plugin? =
You must install the [Clicface Trombi plugin](http://wordpress.org/plugins/clicface-trombi/), which is needed to load the employee database.
...
For unlimited use, we suggest you to choose the best version for you with our [comparison table](https://plugins.clicface.com/pricing/).

= I can not run the plugin. Where can I find help? =
If you need help, feel free to contact us using the [Support Ticket System](http://support.clicface.com/).

*You can check more FAQ [on our website](https://plugins.clicface.com/documentation/faq).*

== Screenshots ==
Screenshots are available on the [Clicface website](https://plugins.clicface.com/screenshots).

== Changelog ==
= 2.03 =
* Fixing issue with last WordPress version 4.7

= 2.02 =
* Improving Clicface Trombi activation checking

= 2.01 =
* Removing Piklist dependency

= 1.03 =
* Updating Clicface links
