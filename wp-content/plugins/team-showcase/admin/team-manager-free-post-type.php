				...
				<div class="wrap">
					<table class="form-table">
						<tr valign="top">
							...
							<td style="vertical-align:middle;">
								If you need any helps, please don't hesitate to post it on <a href="https://wordpress.org/support/plugin/team-showcase">WordPress.org Support Forum</a> or <a href="https://themepoints.com/questions-answer/">Themepoints Support Forum</a>.
							</td>
						</tr>
						<tr valign="top">
							...
							<td style="vertical-align:middle;">
								We spend plenty of time to develop a plugin like If you like this plugin, please rate it 
								<a target="_blank" style="color: red;font-size: 20px;margin-left: 5px;" href="https://wordpress.org/support/plugin/team-showcase/reviews/"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></a>. If you have any problems with the plugin, please let us know before leaving a review. we try to solve your problem as soon as we can.
							</td>
						</tr>
					</table>
				</div>
