...
*/
	...
	function team_manager_free_buy_action_links( $links ) {
		$links[] = '<a href="https://themepoints.com/product/team-showcase-pro/" style="color: red; font-weight: bold;" target="_blank">Buy Pro!</a>';
		return $links;
	}
...
function team_free_plugins_options_framwrork_inc() {
	...
	if ( ! isset( $_REQUEST['updated'] ) ) {
		...
		<div class="wrap about-wrap">
			<h1 style="text-align:left">Welcome to Team Showcase V1.3</h1>
