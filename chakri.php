...
{
header("location: new-org-chart.html");
}
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="904" style="background-color:#06C">
	<tr>
		<td width="194" height="153" align="center" bgcolor="#FFFFFF" ><img src="images/Company-logo.jpg" alt=""></td>

		<td width="419" bgcolor="#FFFFFF"><img src="images/spacer.gif" width="5" height="1" border="0" alt="">
		  <table border="0" align="center" cellpadding="0" cellspacing="0" class="mainnav">
		    <tr>
		      <td width="393" align="center"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
		        <tr>
<nav class="dropdownmenu">
  <ul>
    <li><a href="http://empeiros.internship-test.us">Home</a></li>
    <li><a href="http://empeiros.internship-test.us/contact/">ContactUs</a></li>
        <li><a http://empeiros.internship-test.us/services/">Services</a></li>
    <li><a href="http://empeiros.internship-test.us/technologies/">Technologies</a></li>
          <li><a href="http://empeiros.internship-test.us/login.php">Login Page</a></li>
  </ul>
</nav>
         ...
         <div style = "width:300px; border: solid 1px #30A6E6; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "post" id="myForm">
                  <label>UserName  :</label><input type = "text" onkeypress="return validText(event,this);"rtitle="Only validText are Allowed" name = "Username" class = "box" required/><br/><br />
